...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found:  The first person returned was <Sue> instead of <Bob>. The queue order is incorrect.
    ...
    // Defect(s) Found: the add person mid way failed was expecting <Bob> but got <Sue>.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found:  The queue order or infinite turns logic is incorrect expected <Bob> but got <Sue>.
    ...
    // Defect(s) Found:  The queue order or infinite turns logic is incorrect. tim was expected but got sue.
    ...
    // Defect(s) Found: no defect is found.
